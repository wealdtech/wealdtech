...
import com.wealdtech.limiter.service.LimiterStatsServiceStaticImpl;
...
public class TestApplicationModule extends AbstractModule
{
  ...
  {
    bind(LimiterStatsService.class).to(LimiterStatsServiceStaticImpl.class).in(Singleton.class);
  }
}
