 ...
 */
@JsonTypeName("medium")
public class MediumHandle extends SiteHandle<MediumHandle> implements Comparable<MediumHandle>
{
  private static final String _TYPE = "medium";

  private static final Pattern ACCOUNT_URL = Pattern.compile("^https?://(www\\.)?medium\\.com/@([^/?]+)");

  public MediumHandle(final Map<String, Object> data)
  {
    super(data);
  }
  ...
  public static class Builder<P extends Builder<P>> extends SiteHandle.Builder<MediumHandle, P>
  {
    public Builder()
    {
      super();
    ...
    public Builder(final MediumHandle prior)
    {
      super(prior);
    }

    public MediumHandle build()
    {
      return new MediumHandle(data);
    }
  }
  ...
  public static Builder<?> builder(final MediumHandle prior)
  {
