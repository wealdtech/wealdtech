 ...
 */
@JsonTypeName("vimeo")
public class VimeoHandle extends SiteHandle<VimeoHandle> implements Comparable<VimeoHandle>
{
  private static final String _TYPE = "vimeo";

  private static final Pattern ACCOUNT_URL = Pattern.compile("^https?://(www\\.)?vimeo\\.com/([^/?]+)");

  public VimeoHandle(final Map<String, Object> data)
  {
    super(data);
  }
  ...
  public static class Builder<P extends Builder<P>> extends SiteHandle.Builder<VimeoHandle, P>
  {
    public Builder()
    {
      super();
    ...
    public Builder(final VimeoHandle prior)
    {
      super(prior);
    }

    public VimeoHandle build()
    {
      return new VimeoHandle(data);
    }
  }
  ...
  public static Builder<?> builder(final VimeoHandle prior)
  {
