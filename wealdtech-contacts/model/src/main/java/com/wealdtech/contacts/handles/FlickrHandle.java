 ...
 */
@JsonTypeName("flickr")
public class FlickrHandle extends SiteHandle<FlickrHandle> implements Comparable<FlickrHandle>
{
  private static final String _TYPE = "flickr";

  private static final Pattern ACCOUNT_URL = Pattern.compile("^https?://(www\\.)?flickr\\.com/photos/([^/?]+)");

  public FlickrHandle(final Map<String, Object> data)
  {
    super(data);
  }
  ...
  public static class Builder<P extends Builder<P>> extends SiteHandle.Builder<FlickrHandle, P>
  {
    public Builder()
    {
      super();
    ...
    public Builder(final FlickrHandle prior)
    {
      super(prior);
    }

    public FlickrHandle build()
    {
      return new FlickrHandle(data);
    }
  }
  ...
  public static Builder<?> builder(final FlickrHandle prior)
  {
