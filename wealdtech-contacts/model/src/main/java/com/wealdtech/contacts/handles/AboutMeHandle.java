 ...
 * An About Me handle
 */
@JsonTypeName("aboutme")
public class AboutMeHandle extends SiteHandle<AboutMeHandle> implements Comparable<AboutMeHandle>
{
  private static final String _TYPE = "aboutme";

  private static final Pattern ACCOUNT_URL = Pattern.compile("^https?://(www\\.)?about\\.me/([^/?]+)");

  public AboutMeHandle(final Map<String, Object> data)
  {
    super(data);
  }
  ...
  public static class Builder<P extends Builder<P>> extends SiteHandle.Builder<AboutMeHandle, P>
  {
    public Builder()
    {
      super();
    ...
    public Builder(final AboutMeHandle prior)
    {
      super(prior);
    }

    public AboutMeHandle build()
    {
      return new AboutMeHandle(data);
    }
  }
  ...
  public static Builder<?> builder(final AboutMeHandle prior)
  {
