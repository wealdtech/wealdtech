 ...
 * A facebook handle
 */
@JsonTypeName("facebook")
public class FacebookHandle extends SiteHandle<FacebookHandle> implements Comparable<FacebookHandle>
{
  private static final String _TYPE = "facebook";

  private static final Pattern ACCOUNT_URL = Pattern.compile("^https?://(www\\.)?facebook\\.com/([^/?]+)");

  public FacebookHandle(final Map<String, Object> data)
  {
    super(data);
  }
  ...
  public static class Builder<P extends Builder<P>> extends SiteHandle.Builder<FacebookHandle, P>
  {
    public Builder()
    {
      super();
    ...
    public Builder(final FacebookHandle prior)
    {
      super(prior);
    }

    public FacebookHandle build()
    {
      return new FacebookHandle(data);
    }
  }
  ...
  public static Builder<?> builder(final FacebookHandle prior)
  {
