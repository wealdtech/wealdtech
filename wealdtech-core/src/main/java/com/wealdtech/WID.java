 ...
 * </ul>
 * It is envisaged that the WID will be generated by a database or a WID generating service so that the ID part can
 * be constrained using a sequence or similar.
 * <p>
...
public class WID<T> implements Comparable<WID<T>>, Serializable
{
   ...
   * The string representation is expected to be a hex value.
